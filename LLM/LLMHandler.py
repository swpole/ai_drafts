...
GLOBAL_TASK_FOR_LLM = "Пример задания из глобальной переменной"
class LLMHandler:
    """
    ...
    def create_interface(self):
        ...
        with gr.Blocks(title="LLM Interface", theme="soft") as interface:
            ...
            with gr.Row():
                ...
                set_global_task_btn = gr.Button("📌 Использовать глобальное задание")
            ...
            response_output = gr.Textbox(
                ...
                show_copy_button=True
                        ...
                        # 🔹 Обработчик кнопки "Использовать глобальное задание"
            def set_global_task():
                return GLOBAL_TASK_FOR_LLM

            set_global_task_btn.click(
                fn=set_global_task,
                inputs=None,
                outputs=user_prompt
            )
