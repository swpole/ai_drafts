...
class TextboxWithSTT(gr.Textbox):
    """
    ...
    def create_interface(self):
        ...
        with gr.Blocks() as demo:
            ...
            audio_input.change(
                ...
                inputs=[audio_input, self.recognized_text, cursor_pos,
                    engine_dropdown,
                    google_cloud_key,
                    houndify_client_id,
                    houndify_client_key,
                ...
                outputs=[self.recognized_text, audio_input]
            )
            ...
            self.recognized_text.change(fn=None, inputs=None, outputs=cursor_pos, js=get_cursor_js)
            self.recognized_text.input(fn=None, inputs=None, outputs=cursor_pos, js=get_cursor_js)
            self.recognized_text.submit(fn=None, inputs=None, outputs=cursor_pos, js=get_cursor_js)
            self.recognized_text.focus(fn=None, inputs=None, outputs=cursor_pos, js=get_cursor_js)
            self.recognized_text.blur(fn=None, inputs=None, outputs=cursor_pos, js=get_cursor_js)
            self.recognized_text.select(fn=None, inputs=None, outputs=cursor_pos, js=get_cursor_js)
