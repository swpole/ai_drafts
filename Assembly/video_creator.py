...
class VideoCreator:
    ...
    def create_interface(self):
        ...
        with gr.Blocks() as demo:
            gr.Markdown("# 🎬 Создатель видео из галереи (Классовая версия)")
...
if __name__ == "__main__":
    # Создаем экземпляр класса с 2 параллельными треками
    video_creator = VideoCreator(num_parallel_tracks=2)
    
    # Создаем и запускаем интерфейс
    demo = video_creator.create_interface()
    demo.launch()