...
class LLMInterfaceOnline:
    ...
    def build_interface(self):
        ...
        with gr.Accordion("⚙️ Настройки промптов и модели", open=False):
            ...
            prompt_box = TextboxWithSTTOnline(
        ...
        self.input_box = TextboxWithSTTOnline(
        ...
        self.output_box = TextboxWithSTTOnline(
...
if __name__ == "__main__":
    ...
    with gr.Blocks() as demo:
        summarizer = LLMInterfaceOnline(typical_prompts={
