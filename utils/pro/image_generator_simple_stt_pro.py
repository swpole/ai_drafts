    ...
    def create_interface(self):
            ...
            with gr.Column():
                ...
                with gr.Accordion("⚙️ Настройки генерации", open=False):
                    ...
                    sampler_name = gr.Dropdown(
                        choices=["Euler a", "Euler", "LMS", "Heun", "DPM2", "DPM2 a", "DPM++ 2S a", "DPM++ 2M", "DPM++ SDE", "DPM fast", "DPM adaptive"],
                        value="Euler a",
                        label="Sampler"
                    )
                    
                    scheduler = gr.Dropdown(
                        choices=["karras", "karras_ema", "heun", "dpm_2", "dpm_2_ema", "dpm++_2", "dpm++_2_ema", "dpm_fast", "dpm_adaptive"],
                        value="karras",
                        label="Scheduler"
                    )
                ...
                self.positive_prompt = TextboxWithSTTPro(
        ...
        generate_btn.click(
            ...
            inputs=[
                ...
                self.positive_prompt.textbox, negative_prompt,
...
if __name__ == "__main__":
    ...
    with gr.Blocks(title="ComfyUI Image Generator (simple with STT)") as interface:
        ...
        interface.launch(
                ...
                allowed_paths=[generator.output_dir]  # Разрешаем автоматически найденный путь
            )