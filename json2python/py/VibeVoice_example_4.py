...
def main():
    ...
    loadaudio_12_output = loadaudio_12.load(audio="5.wav")
    # Output available as loadaudio_12_output
    
    loadaudio_13 = LoadAudio()
    loadaudio_13_output = loadaudio_13.load(audio="5.wav")
    # Output available as loadaudio_13_output
    
    vibevoicettsnode_11 = VibeVoiceTTSNode()
    vibevoicettsnode_11_output = vibevoicettsnode_11.generate_audio(model_name="VibeVoice-Large", 
...
Speaker 1: Кошмар? Это же оправдание ты использовал в прошлый раз. Я начинаю думать, что тебе просто всё равно. Легче сказать «работа была сумасшедшей», чем признать, что я больше не в приоритете для тебя.", 
                                                                    ...
                                                                    top_k=0, 
                                                                    force_offload=False, 
                                                                    speaker_1_voice=loadaudio_4_output[0], 
                                                                    speaker_2_voice=loadaudio_8_output[0], 
                                                                    speaker_3_voice=loadaudio_12_output[0], 
                                                                    speaker_4_voice=loadaudio_13_output[0])
